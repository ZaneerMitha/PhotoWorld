...
/**
 * Tests all the methods in BasicPhotoEditorController.
 */
public class BasicPhotoEditorControllerTest {
  ...
  public void testInvalidConstructor() {
    ...
    try {
      ...
      SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
      Readable reader = new StringReader("");
      SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
    } catch (IllegalArgumentException ex) {
      assertEquals("Model is null", ex.getMessage());
    }

    try {
      SuperPhotoEditorModel model = new BasicPhotoEditorModel();
      Appendable in = new StringBuilder();
      SuperPhotoEditorView view = null;
      Readable reader = new StringReader("");
      SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
    } catch (IllegalArgumentException ex) {
      assertEquals("View is null", ex.getMessage());
    }
  ...
  public void testLoadPPM() {
    ...
    Image koala = model.getDesiredImage("Koala");
    assertEquals(1024, koala.getWidth());
    assertEquals(768, koala.getHeight());

    Pixel firstPixel = koala.getPixelAt(0, 0);
    assertEquals(101, firstPixel.getPixelValue());
    assertEquals(83.0, firstPixel.getPixelIntensity(), 0.0);
    assertEquals(90.0282, firstPixel.getPixelLuma(), 0.0);

    Pixel secondPixel = koala.getPixelAt(0, 1);
    assertEquals(103, secondPixel.getPixelValue());
    assertEquals(85.66666666666667, secondPixel.getPixelIntensity(), 0.0);
    assertEquals(92.1726, secondPixel.getPixelLuma(), 0.0);

    Pixel thirdPixel = koala.getPixelAt(0, 2);
    assertEquals(110, thirdPixel.getPixelValue());
    assertEquals(90.33333333333333, thirdPixel.getPixelIntensity(), 0.0);
    assertEquals(96.09519999999998, thirdPixel.getPixelLuma(), 0.0);
  }
  ...
  public void testSavePPM() {
    ...
    try {
      controller.save("images/image.ppm", "image");
    } catch (IOException e) {
      throw new RuntimeException(e);
    }

    try {
      controller.load("images/image.ppm", "image");
    } catch (IOException e) {
      throw new RuntimeException(e);
    }
  ...
  public void testLoadPNG() {
    ...
    try {
      controller.load("res/manhattan-small.png", "manhattan-small");
    } catch (IOException e) {
      throw new RuntimeException(e);
    }
  ...
  public void testSavePNG() {
    ...
    SuperPhotoEditorModel model = new BasicPhotoEditorModel();
    model.acceptImage("image2", image);
    ...
    try {
      controller.save("res/image2.png", "image2");
    } catch (IOException e) {
      throw new RuntimeException(e);
    }

    try {
      controller.load("res/image2.png", "image2");
    } catch (IOException e) {
      throw new RuntimeException(e);
    }

    Image manhattan = model.getDesiredImage("image2");
    assertEquals(3, manhattan.getWidth());
    assertEquals(3, manhattan.getHeight());

    Pixel firstPixel = manhattan.getPixelAt(0, 0);
    assertEquals(0, firstPixel.getPixelValue());
    assertEquals(0, firstPixel.getPixelIntensity(), 0.0);
    assertEquals(0, firstPixel.getPixelLuma(), 0.0);

    Pixel secondPixel = manhattan.getPixelAt(0, 1);
    assertEquals(0, secondPixel.getPixelValue());
    assertEquals(0, secondPixel.getPixelIntensity(), 0.0);
    assertEquals(0, secondPixel.getPixelLuma(), 0.0);

    Pixel thirdPixel = manhattan.getPixelAt(0, 2);
    assertEquals(0, thirdPixel.getPixelValue());
    assertEquals(0, thirdPixel.getPixelIntensity(), 0.0);
    assertEquals(0, thirdPixel.getPixelLuma(), 0.0);
  ...
  public void testLoadJPG() {
    ...
    try {
      controller.load("res/EZ.jpg", "EZ");
    } catch (IOException e) {
      throw new RuntimeException(e);
    }

    Image elijahZaneer = model.getDesiredImage("EZ");
    assertEquals(1170, elijahZaneer.getWidth());
    assertEquals(853, elijahZaneer.getHeight());

    Pixel firstPixel2 = elijahZaneer.getPixelAt(0, 0);
    assertEquals(184, firstPixel2.getPixelValue());
    assertEquals(152.33333333333334, firstPixel2.getPixelIntensity(), 0.0);
    assertEquals(157.20799999999997, firstPixel2.getPixelLuma(), 0.0);

    Pixel secondPixel2 = elijahZaneer.getPixelAt(0, 1);
    assertEquals(183, secondPixel2.getPixelValue());
    assertEquals(151.33333333333334, secondPixel2.getPixelIntensity(), 0.0);
    assertEquals(156.208, secondPixel2.getPixelLuma(), 0.0);

    Pixel thirdPixel2 = elijahZaneer.getPixelAt(0, 2);
    assertEquals(185, thirdPixel2.getPixelValue());
    assertEquals(153.33333333333334, thirdPixel2.getPixelIntensity(), 0.0);
    assertEquals(158.208, thirdPixel2.getPixelLuma(), 0.0);
  }
  ...
  public void testSaveJPG() {
    ...
    try {
      controller.save("res/image2.jpg", "image2");
    } catch (IOException e) {
      throw new RuntimeException(e);
    }

    try {
      controller.load("res/image2.jpg", "image2");
    } catch (IOException e) {
      throw new RuntimeException(e);
    }
  ...
  public void testSaveBMP() {
    ...
    try {
      controller.save("res/image2.bmp", "image2");
    } catch (IOException e) {
      throw new RuntimeException(e);
    }

    try {
      controller.load("res/image2.bmp", "image2");
    } catch (IOException e) {
      throw new RuntimeException(e);
    }
  ...
  @Test
  public void testEditPhotoLoadPPM() {
    SuperPhotoEditorModel model = new BasicPhotoEditorModel();
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("load images/Koala.ppm Koala\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
  ...
  @Test
  public void testEditPhotoSavePPM() {
    RGBColor color = new RGBColor(0, 0, 0);
    Posn zeroZero = new Posn(0, 0);
    Posn zeroOne = new Posn(0, 1);
    Posn zeroTwo = new Posn(0, 2);
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("save images/image.ppm image\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
  ...
  @Test
  public void testEditPhotoLoadPNG() {
    SuperPhotoEditorModel model = new BasicPhotoEditorModel();
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("load res/manhattan-small.png manhattan-small\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
    ...
    Pixel firstPixel = manhattan.getPixelAt(0, 0);
    assertEquals(212, firstPixel.getPixelValue());
    assertEquals(182.33333333333334, firstPixel.getPixelIntensity(), 0.0);
    assertEquals(178.5032, firstPixel.getPixelLuma(), 0.0);

    Pixel secondPixel = manhattan.getPixelAt(0, 1);
    assertEquals(212, secondPixel.getPixelValue());
    assertEquals(182.33333333333334, secondPixel.getPixelIntensity(), 0.0);
    assertEquals(178.5032, secondPixel.getPixelLuma(), 0.0);

    Pixel thirdPixel = manhattan.getPixelAt(0, 2);
    assertEquals(212, thirdPixel.getPixelValue());
    assertEquals(182.33333333333334, thirdPixel.getPixelIntensity(), 0.0);
    assertEquals(178.5032, thirdPixel.getPixelLuma(), 0.0);
  }

  @Test
  public void testGoSavePNG() {
    RGBColor color = new RGBColor(0, 0, 0);
    Posn zeroZero = new Posn(0, 0);
    Posn zeroOne = new Posn(0, 1);
    Posn zeroTwo = new Posn(0, 2);
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("save res/image2.png image2\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
    ...
    Image image2 = model.getDesiredImage("image2");
    assertEquals(3, image2.getWidth());
    assertEquals(3, image2.getHeight());

    Pixel firstPixel = image2.getPixelAt(0, 0);
    assertEquals(0, firstPixel.getPixelValue());
    assertEquals(0, firstPixel.getPixelIntensity(), 0.0);
    assertEquals(0, firstPixel.getPixelLuma(), 0.0);

    Pixel secondPixel = image2.getPixelAt(0, 1);
    assertEquals(0, secondPixel.getPixelValue());
    assertEquals(0, secondPixel.getPixelIntensity(), 0.0);
    assertEquals(0, secondPixel.getPixelLuma(), 0.0);

    Pixel thirdPixel = image2.getPixelAt(0, 2);
    assertEquals(0, thirdPixel.getPixelValue());
    assertEquals(0, thirdPixel.getPixelIntensity(), 0.0);
    assertEquals(0, thirdPixel.getPixelLuma(), 0.0);
  ...
  @Test
  public void testEditPhotoLoadJPG() {
    SuperPhotoEditorModel model = new BasicPhotoEditorModel();
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("load res/EZ.jpg EZ\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
  ...
  @Test
  public void testEditPhotoSaveJPG() {
    RGBColor color = new RGBColor(0, 0, 0);
    Posn zeroZero = new Posn(0, 0);
    Posn zeroOne = new Posn(0, 1);
    Posn zeroTwo = new Posn(0, 2);
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("save res/image2.jpg image2\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
  ...
  @Test
  public void testEditPhotoSaveBMP() {
    RGBColor color = new RGBColor(0, 0, 0);
    Posn zeroZero = new Posn(0, 0);
    Posn zeroOne = new Posn(0, 1);
    Posn zeroTwo = new Posn(0, 2);
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("save res/image2.bmp image2\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
  ...
  @Test
  public void testGoFlipVertical() {
    RGBColor color = new RGBColor(0, 0, 0);
    Posn zeroZero = new Posn(0, 0);
    Posn zeroOne = new Posn(0, 1);
    Posn zeroTwo = new Posn(0, 2);
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("vertical-flip image image-vertical\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
  ...
  @Test
  public void testGoFlipHorizontal() {
    RGBColor color = new RGBColor(0, 0, 0);
    Posn zeroZero = new Posn(0, 0);
    Posn zeroOne = new Posn(0, 1);
    Posn zeroTwo = new Posn(0, 2);
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("horizontal-flip image image-horizontal\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
  ...
  public void testGoBrighten() {
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("brighten 10 image image-brighter\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
  ...
  public void testGoDarken() {
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("brighten -10 image image-darker\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
  ...
  @Test
  public void testGoVisualizeRed() {
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("value-component image2 image2-greyscale\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
  ...
  @Test
  public void testGoVisualizeGreen() {
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("green-component image2 image2-greyscale\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
  ...
  @Test
  public void testGoVisualizeBlue() {
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("blue-component image2 image2-greyscale\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
  ...
  @Test
  public void testGoVisualizeValue() {
  ...
  @Test
  public void testGoVisualizeIntensity() {
    RGBColor color = new RGBColor(15, 10, 5);
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("intensity-component image2 image2-greyscale\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
  ...
  @Test
  public void testGoVisualizeLuma() {
    RGBColor color = new RGBColor(15, 10, 5);
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("luma-component image2 image2-greyscale\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
  ...
  public void testBlur() {
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("blur image2 image2-blurred\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
  ...
  public void testSharpen() {
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("sharpen image3 image3-blurred\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
    ...
    assertTrue(imageSharpen.equals(model.getDesiredImage("image3-blurred")));
  }
  ...
  public void testSepiaTone() {
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("sepia image2 image2-sepia\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
  ...
  @Test
  public void testGreyscaleKernalImage() {
    Posn zeroZero = new Posn(0,0);
    Posn zeroOne = new Posn(0,1);
    Posn zeroTwo = new Posn(0,2);
    Posn oneZero = new Posn(1,0);
    ...
    Appendable in = new StringBuilder();
    SuperPhotoEditorView view = new BasicPhotoEditorView(model, in);
    Readable reader = new StringReader("greyscale image2 image2-greyscale\n");
    SuperPhotoEditorController controller = new BasicPhotoEditorController(model, view, reader);
